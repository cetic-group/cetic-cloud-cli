...
app.add_typer(scale_set.container_app, name="ct-scale-set")
# Alias rétro-compat : `cetic scale-set` reste accepté (renommé en ct-scale-set).
app.add_typer(scale_set.container_app, name="scale-set", hidden=True)
